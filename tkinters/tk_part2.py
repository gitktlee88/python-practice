...
image = PhotoImage(file="cock.png") # edit the file name to use a different image
...
Label(tool_bar, text="Tools", bg='powder blue', relief=RAISED).grid(row=0, column=0,
                                                  padx=5, pady=3, ipadx=10)
Label(tool_bar, text="Filters", bg='powder blue', relief=RAISED).grid(row=0, column=1, 
                                                    padx=5, pady=3, ipadx=10)
