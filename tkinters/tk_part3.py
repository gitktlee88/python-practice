...
btn_ipady = Button(root, text="ipady of 10")
btn_ipady.grid(ipady=10)

btn_padx = Button(root, text="padx of 10")
btn_padx.grid(padx=10)

btn_pady = Button(root, text="pady of 10")
btn_pady.grid(pady=10)
...
btn_sticky.grid(pady=5,sticky=NE)
